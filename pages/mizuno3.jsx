...
import mizuno3bImg from "../public/assets/projects/mizuno3b.png";
    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-4 gap-8 py-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p className="mt-5">
            ULTIMATE BAREFOOT & FEEL SPEED MD
            <br />
            Get the ultimate durable fit that‘s so comfortable and lightweight,
            it feels like you‘re barefoot. Has all thepremium features you want
            including the external heel counter, high-quality K-Leather, and
            engineered fit last for a shoe that is truly worthy of the label‚
            Made in Japan.
          </p>
        </div>
